...
Configus.build App.env do
  env :default do
    debug false

    http_server do
      host Nenv.http_api_host || '0.0.0.0'
      port Nenv.http_api_port || '3000'
    end

    ping do
      retries_count 0
      time_out Nenv.ping_timeout.to_i
      interval Nenv.ping_interval.to_i
      quantize Nenv.ping_quantize.to_f
    end
